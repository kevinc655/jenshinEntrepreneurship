public class ArtifactCirclet
{
    ...
    public double GetMainStatNumber(String artifactMainStatName, double artifactLevel)
    {
        ...
        for (int i = 0; i <= artifactLevel; i++)
        {
            ...
            else if (artifactMainStatName.equals("CR"))
            {
                if (i == 0)
                {returnStat += 4.70;}
                else
            ...
            else if (artifactMainStatName.equals("CD"))
            {
                if (i == 0)
                {returnStat += 9.30;}
                else
                {
                    returnStat += 2.60;
                    if (i == 1 || i == 3 || i == 6 || i == 8 || i == 11 || i == 13 || i == 15 || i == 18 || i == 20)
                    {
                        returnStat += 0.10;
                    }
                }
