public class ArtifactGoblet
{
    ...
    public double GetMainStatNumber(String artifactMainStatName, double artifactLevel)
    {
        ...
        {
            if (artifactMainStatName.equals("PercentHP") || artifactMainStatName.equals("PercentATK") || artifactMainStatName.equals("PyroDMG") || artifactMainStatName.equals("HydroDMG") || artifactMainStatName.equals("AnemoDMG") || artifactMainStatName.equals("ElectroDMG") || artifactMainStatName.equals("DendroDMG") || artifactMainStatName.equals("CryoDMG") || artifactMainStatName.equals("GeoDMG"))
            {
                if (i == 0)
                {returnStat += 7.00;}
                else
            ...
            else if (artifactMainStatName.equals("PercentDEF") || artifactMainStatName.equals("PhysicalDMG"))
            {
                if (i == 0)
                {returnStat += 8.70;}
                else
